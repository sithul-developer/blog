                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="orders">
                                                <option {{-- {{ $sliders->status == 1 ? 'selected' : '' }} --}}>--- Selcetd Order --- </option>
                                                <option {{-- {{ $sliders->status == 1 ? 'selected' : '' }} --}} value='2'>Top News </option>
                                                <option {{-- {{ $sliders->status == 1 ? 'selected' : '' }} --}} value='1'> 1</option>
                                                <option {{-- {{ $sliders->status == 1 ? 'selected' : '' }} --}} value='0'> 0</option>
                                            ...
                                            <div class=" d-flex">
                                                ...
                                                @foreach ($tags as $item)
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" name="tag[]"
                                        ...
                                        <section class="content">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <textarea id="editor" name="content" style="border-radius: 10px"></textarea>
                                                    </div>
                                                </div>
                                                <!-- /.col-->
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        flex-direction: column;">
                                            ...
                                            <img id="blah" class="img_post"
                                                ...
                                                alt="your image" class="mt-2" style=""  />
                                        </div>
                                    </div>
                                    @if (count($errors) > 0)
